                ...
                {data.map((element)=>{
                    return(
                        <Link to={`/product/${element.id}`}>
                            <div key={element.id} id={element.id} className="hidden lg:block rounded-3xl my-[10%] bg-[#070707] pb-8 hover:bg-[#0a0a0a] hover:rounded-xl transition-all duration-100 overflow-hidden">
